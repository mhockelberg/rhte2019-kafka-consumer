...
public class Customers {
	...
	public Customers(ChangeEvent changeEvent) {

		this.id = changeEvent.getPayload().getAfter().getId().intValue();
		this.firstName = changeEvent.getPayload().getAfter().getFirstName().toString();
		this.lastName = changeEvent.getPayload().getAfter().getLastName().toString();
		this.email = changeEvent.getPayload().getAfter().getEmail().toString();
